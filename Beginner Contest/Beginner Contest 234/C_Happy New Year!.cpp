...
{
	ll n; cin>>n;
	// considering '1' instead of '2'
	// we can breakdown the problem easily, and replace '1' with '2'
	// using '0' and '1' the string is nothing but the binary representation of the number n
	string s;
	while (n)
	{
		if (n&1) s.pb('2');
